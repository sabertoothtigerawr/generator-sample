...
var Generator = module.exports = function Generator(args, options) {
  ...
  this.hookFor('sample:common', {
    args: args
  });

  this.hookFor('sample:main', {
    args: args
  });

  this.hookFor('sample:controller', {
    args: args
  });
...
Generator.prototype.askFor = function askFor() {
  ...
  this.prompt(prompts, function (props) {
    ...
    this.log(yosay("hello " + props.yourname + "!"));
    cb();
  }.bind(this));
};
//add end--------------------------------------------------------
